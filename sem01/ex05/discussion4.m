...
% discussion 4, what happens if h(1)=0.5, t=0:0.01:100, ie=65 nA/mm^2 ?
...
t = 0 : 0.1 : 100;      % time vector from 0 to 40 ms
ie =65;                 % constant input current (nA/mm^2)
...
h(1)=0.5;               % at t=0, half oh gates are open!
